...
class App extends Component {
    constructor(props) {
        ...
        this.state = {
            data: [
                { name: 'Alex J.', salary: 500, increase: false, like: false, id: 1 },
                { name: 'Json S.', salary: 1000, increase: false, like: true, id: 2 },
                { name: 'Tom C.', salary: 1500, increase: false, like: false, id: 3 },
            ],
            tern: '',
            filter: 'all'
        }
